...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val desc = TextView(this).apply {
            text = "برای فعال‌سازی و استفاده از موس شناور و پنل کلیک مستقل:"
            textSize = 14f
        ...
        val guideTitle = TextView(this).apply {
            text = "\n💡 راهنمای جابه‌جایی آیکون‌ها و مفاصل میکسامو (Mixamo):"
            textSize = 16f
        ...
        val guideText = TextView(this).apply {
            text = "• جابه‌جایی دقیق آیکون‌های گوشی و دایره‌های میکسامو (Mixamo Rigging):\n" +
                   "  ۱. نوک نشانگر موس را دقیقاً روی آیکون یا دایره مفصل قرار دهید.\n" +
                   "  ۲. دکمه 'گرفتن 📍' را بزنید (مکث ۳۰۰ میلی‌ثانیه‌ای برای شناسایی شیء اعمال می‌شود).\n" +
                   "  ۳. نشانگر موس را به محل جدید ببرند.\n" +
                   "  ۴. دکمه 'رها 🎯' را بزنید تا شیء/مفصل منتقل شود.\n\n" +
                   "• کلیک طولانی (Long Press): دکمه 'نگه‌داشتن' برای لمس و نگه‌داشتن آیکون‌ها تعبیه شده است.\n\n" +
                   "• بازکردن مجدد موس پس از بستن: روی حباب شناور 🖱️ بزنید یا دکمه ۳ بالا را در برنامه فشار دهید."
            textSize = 13f
